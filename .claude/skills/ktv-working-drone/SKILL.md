...
- Código de documentos: prefijo **KWD-**. **Azul corporativo oficial: #02BEFD** (Pantone 299C — es el cian saturado REAL que usa el material de marca del franquiciante, medido de la portada del PDF KTV Care). Azul de apoyo más oscuro #00AADF (para texto de títulos sobre blanco), carbón/negro #171E27 para zonas oscuras. Logo ktvwd23. Todo en español.
  - ⚠️ OJO con el manual: tiene 3 valores inconsistentes para "su azul" — texto "web code #34C7FF" (RGB 52,199,255, sale pastel/lavado), "RGB 65/182/230" (#41B6E6) y la portada real del PDF que renderiza **#02BEFD** (RGB 2,190,253). El correcto es el de la portada = **#02BEFD** (es el que Gerencia reconoce como su marca). NO usar #34C7FF (pastel) ni #2E75B6 (azul viejo/erróneo de otra sesión).
