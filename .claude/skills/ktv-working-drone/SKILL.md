...
- Código de documentos: prefijo **KWD-**. **Azul corporativo oficial: #66C3F8 (RGB 102,195,248)** — medido por Gerencia con el cuentagotas directamente del PowerPoint oficial de marca (2026-07-11). Es el valor DEFINITIVO, confirmado por Gerencia. Carbón/negro **#171E27** para zonas oscuras (encabezados, filas de total) y para el TEXTO de los títulos sobre blanco (la barra lateral del título sí va en #66C3F8). Un solo azul en todo. Logo ktvwd23. Español.
