...
- Código de documentos: prefijo **KWD-**. **Azul corporativo oficial: #41B6E6** (Pantone 299C — es el sRGB que declara el manual: R:65 G:182 B:230, y es EXACTAMENTE el azul del header del propio manual de marca; CMYK C65/M8/Y0/K0). Carbón/negro **#171E27** para zonas oscuras (encabezados, filas de total) y para el TEXTO de los títulos sobre blanco (la barra lateral del título sí va en #41B6E6). Un solo azul en todo. Logo ktvwd23. Español.
  - ⚠️ OJO con el manual: da valores inconsistentes — su texto "web code #34C7FF" (pastel/lavado, ERRÓNEO, no coincide con su propio sRGB) y la portada del PDF KTV Care renderiza #02BEFD (saturado). Gerencia confirmó (2026-07-11, mostrando el header del manual) que el correcto es el **sRGB = #41B6E6**. NO usar #34C7FF, ni #02BEFD, ni #2E75B6.
